...
var _default = {
  ...
  methods: {
            ...
            uni.request({
              ...
              success: function success(res) {
                ...
                for (var idx = 0; idx < res.data["data"]["devices"].length; idx++) {
                  var device_data = res.data["data"]["devices"][idx];
                  // 修改顺序 data0 data2 ..
                  device_data["datastreams"].sort(function (a, b) {
                  ...
                  for (var in_idx = 0; in_idx < device_data["datastreams"].length; in_idx++) {
                    if (device_data["datastreams"][in_idx]["id"] == "location") {
                      ...
                      uni.request({
                        ...
                        header: {
                          "api-key": "CSwWZsNXKRVJz=XUMES=qfO7p8Q="
                        },
                        method: 'GET',
    ...
    isChinese: function isChinese(s) {
      return /[\u4e00-\u9fa5]/.test(s);
    },
    ench2Unicode: function ench2Unicode(str) {
      if (!str) {
        return;
      }
      var unicode = '';
    ...
    calc_hash: function calc_hash(input_data) {
    ...
    load_config_show: function load_config_show(device_id, key_name, ori_name) {
      var res = "";
      try {
        res = res || this.config_json[device_id]["show"][key_name][ori_name];
      } catch (e) {}
      try {
        res = res || this.config_json["*"]["show"][key_name][ori_name];
      } catch (e) {}
      return res || ori_name;
    },
    check_seen_status: function check_seen_status(device_id, key_name) {
      var action = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
      // try {
      if (action == "") {
        if (((this.config_json[device_id] || {})["hidep"] || []).indexOf(key_name) != -1) return false;
      ...
      if (action == "") {
        if (((this.config_json["*"] || {})["hidep"] || []).indexOf(key_name) != -1) return false;
    ...
    change: function change() {
      ...
      if (that.input_val[10]) {
        uni.setStorageSync("emails", that.input_val[10]);
      }
    ...
    // 修改时间
    changeTime: function changeTime(e, mode) {
      if (mode == "start") {
        this.timeStart = e;
      } else {
        this.timeEnd = e;
      ...
      uni.request({
        ...
        success: function success(res) {
          ...
          for (var in_idx = 0; in_idx < res.data["data"]["datastreams"][0]["datapoints"].length; in_idx++) {
            var translate_coor = that.translate_gps(res.data["data"]["datastreams"][0]["datapoints"][in_idx]["value"]["lat"], res.data["data"]["datastreams"][0]["datapoints"][in_idx]["value"]["lon"]);
    ...
    // 独立子页面 -2
    // 管理定时信息
    jump_manage_timer: function jump_manage_timer() {
      var that = this;
      that.seen_id = -2;
      that.check_main(0);
    ...
    select_timer_item: function select_timer_item(e) {
    ...
    select_timer_time: function select_timer_time(e) {
      this.manage_timer_v['picked'][0] = e.detail.value; // time
      this.$forceUpdate();
    },
    trigger_timer_duplicate: function trigger_timer_duplicate(e) {
      // duplicate
      var select_list = [];
    ...
    select_timer_duplicate: function select_timer_duplicate(e) {
      // duplicate
      var that = this;
    ...
    del_timer_config: function del_timer_config(device_id, idx) {
      var that = this;
      uni.showModal({
    ...
    get_show_info_from_config: function get_show_info_from_config(device_id, rule_list) {
    ...
    // 三方通信部分 - 设定定时信息
    set_timer_info: function set_timer_info() {
      var that = this;
    ...
    // 从服务器拉取同步
    get_timer_info: function get_timer_info() {
      var that = this;
      var send_info = {};
    ...
    // 校验同步信息
    check_timer_version: function check_timer_version() {
      var that = this;
      if (that.config_json['timer']) {
        var send_info = that.config_json['timer'];
        var check_send_info = {};
...
var _default = {
  "pages": [{
    "path": "pages/index/index",
    "style": {
      "navigationBarTitleText": "摸鱼大鸽物联网",
...
exports.default = void 0;
var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 111));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 112));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 113));
var _default = {
  en: _en.default,
  'zh-Hans': _zhHans.default,
  'zh-Hant': _zhHant.default
